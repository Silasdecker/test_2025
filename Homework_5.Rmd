...
m<- matrix(data=n_dims_vec,nrow=sqrt(n_dims2))
print(m)
...
#row4_sum<-sum(m_transposed[4,]) This indexxing needs to be vectorized
#print(row4_sum)
...
#these are all real numbers, some negative some positive 
#all are less than 1
